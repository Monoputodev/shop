                ...
                <div class="feature-card">
                    <div class="feature-media">
                        <div class="feature-label"><label class="label-text feat">feature</label></div><button
                            ...
                            class="feature-image" href="{{ asset('assets/web') }}/product-video.html"><img
                                src="{{ asset('assets/web') }}/images/product/09.jpg" alt="product"></a>
                        <div class="feature-widget"><a title="Product Compare"
                                href="{{ asset('assets/web') }}/compare.html" class="fas fa-random"></a><a
                                title="Product Video"
                                href="{{ asset('assets/web') }}/https://youtu.be/9xzcVxSBbG8"
                                class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a><a
                                title="Product View" href="{{ asset('assets/web') }}/#" class="fas fa-eye"
                                data-bs-toggle="modal" data-bs-target="#product-view"></a></div>
                    </div>
                    <div class="feature-content">
                        <h6 class="feature-name"><a href="{{ asset('assets/web') }}/product-video.html">fresh
                                organic green chilis</a>
                        </h6>
                        <div class="feature-rating"><i class="active icofont-star"></i><i
                                ...
                                href="{{ asset('assets/web') }}/product-video.html">(3 Reviews)</a></div>
                ...
                <div class="feature-card">
                    <div class="feature-media">
                        <div class="feature-label"><label class="label-text feat">feature</label></div><button
                            class="feature-wish wish"><i class="fas fa-heart"></i></button><a
                            class="feature-image" href="{{ asset('assets/web') }}/product-video.html"><img
                                src="{{ asset('assets/web') }}/images/product/10.jpg" alt="product"></a>
                        <div class="feature-widget"><a title="Product Compare"
                                href="{{ asset('assets/web') }}/compare.html" class="fas fa-random"></a><a
                                title="Product Video"
                                href="{{ asset('assets/web') }}/https://youtu.be/9xzcVxSBbG8"
                ...
                <div class="feature-card">
                    <div class="feature-media">
                        <div class="feature-label"><label class="label-text feat">feature</label></div><button
                            class="feature-wish wish"><i class="fas fa-heart"></i></button><a
                            class="feature-image" href="{{ asset('assets/web') }}/product-video.html"><img
                                src="{{ asset('assets/web') }}/images/product/11.jpg" alt="product"></a>
                        <div class="feature-widget"><a title="Product Compare"
                                href="{{ asset('assets/web') }}/compare.html" class="fas fa-random"></a><a
                                title="Product Video"
                                href="{{ asset('assets/web') }}/https://youtu.be/9xzcVxSBbG8"
                ...
                <div class="feature-card">
                    <div class="feature-media">
                        <div class="feature-label"><label class="label-text feat">feature</label></div><button
                            class="feature-wish wish"><i class="fas fa-heart"></i></button><a
                            class="feature-image" href="{{ asset('assets/web') }}/product-video.html"><img
                                src="{{ asset('assets/web') }}/images/product/12.jpg" alt="product"></a>
                        <div class="feature-widget"><a title="Product Compare"
                                href="{{ asset('assets/web') }}/compare.html" class="fas fa-random"></a><a
                                title="Product Video"
                                href="{{ asset('assets/web') }}/https://youtu.be/9xzcVxSBbG8"
                ...
                <div class="feature-card">
                    <div class="feature-media">
                        <div class="feature-label"><label class="label-text feat">feature</label></div><button
                            class="feature-wish wish"><i class="fas fa-heart"></i></button><a
                            class="feature-image" href="{{ asset('assets/web') }}/product-video.html"><img
                                src="{{ asset('assets/web') }}/images/product/13.jpg" alt="product"></a>
                        <div class="feature-widget"><a title="Product Compare"
                                href="{{ asset('assets/web') }}/compare.html" class="fas fa-random"></a><a
                                title="Product Video"
                                href="{{ asset('assets/web') }}/https://youtu.be/9xzcVxSBbG8"
                ...
                <div class="feature-card">
                    <div class="feature-media">
                        <div class="feature-label"><label class="label-text feat">feature</label></div><button
                            class="feature-wish wish"><i class="fas fa-heart"></i></button><a
                            class="feature-image" href="{{ asset('assets/web') }}/product-video.html"><img
                                src="{{ asset('assets/web') }}/images/product/14.jpg" alt="product"></a>
                        <div class="feature-widget"><a title="Product Compare"
                                href="{{ asset('assets/web') }}/compare.html" class="fas fa-random"></a><a
                                title="Product Video"
                                href="{{ asset('assets/web') }}/https://youtu.be/9xzcVxSBbG8"
