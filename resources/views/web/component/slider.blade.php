<section class="home-index-slider slider-arrow slider-dots">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="banner-content">
                        ...
                        <p>Lorem ipsum dolor consectetur adipisicing elit modi consequatur eaque expedita porro
                            ...
                            excepturi</p>
                        <div class="banner-btn"><a class="btn btn-inline"
                                href="{{ asset('assets/web') }}/shop-4column.html"><i
                                    class="fas fa-shopping-basket"></i><span>shop now</span></a><a
                                class="btn btn-outline" href="{{ asset('assets/web') }}/offer.html"><i
                                    class="icofont-sale-discount"></i><span>get offer</span></a></div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="banner-img"><img src="{{ asset('assets/web') }}/images/home/index/01.png"
                            alt="index"></div>
                </div>
            </div>
        </div>
    ...
    <div class="banner-part banner-2">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-6">
                    <div class="banner-img"><img src="{{ asset('assets/web') }}/images/home/index/02.png"
                            alt="index"></div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="banner-content">
